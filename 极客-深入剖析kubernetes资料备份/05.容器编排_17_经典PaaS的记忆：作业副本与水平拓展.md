# 05.容器编排-17-经典PaaS的记忆：作业副本与水平拓展
...
![img](assets/ab4902a0437af4347bec520468c5e7cd.png)
...
![img](assets/79dcd2743645e39c96fafa6deae9d6f6.png)

如上所示，Deployment 的控制器，实际上控制的是 ReplicaSet 的数目，以及每个 ReplicaSet 的属性。

> <font color="red">标注：Deployment 的控制器，实际上控制的是 ReplicaSet 的数目，以及每个 ReplicaSet 的属性。</font>
...
![img](assets/47a6f3bf6b92d58512d5a2ed0a556f55-1563329656217.jpg)