# 05.容器编排-23-声明式API-1-声明式API与Kubernetes编程范式
...
> <font color="red">标注：命令式命令行操作。</font>
...
> <font color="red" >标注：命令式配置文件操作。</font>
...
> <font color="red">标注:命令式API的关键是kubectl apply命令</font>
...
> <font color= red >标注：优势来了：可以多个写入，兼具处理冲突的能力。</font>
...
![img](assets/d38daed2fedc90e20e9d2f27afbaec1b.jpg)
...
> <font color="red">我还能说啥：666呗</font>
...
> <font color="red">标注：知识点来了，拿笔记下来：</font>

- 首先，所谓“声明式”，指的就是我只需要提交一个定义好的 API 对象来“声明”，我所期望的状态是什么样子。

  - > <font color="red">标注：要达到什么目的。</font>

- 其次，“声明式 API”允许有多个 API 写端，以 PATCH 的方式对 API 对象进行修改，而无需关心本地原始 YAML 文件的内容。

  - > <font color="red">标注：不念过去，不畏将来，想干啥，直接干！</font>

- 最后，也是最重要的，有了上述两个能力，Kubernetes 项目才可以基于对 API 对象的增、删、改、查，在完全无需外界干预的情况下，完成对“实际状态”和“期望状态”的调谐（Reconcile）过程。

  - > <font color="red">标注：平稳过渡。</font>
...
此外，基于今天这篇文章所讲述的 Istio 的工作原理，尽管 Istio 项目一直宣称它可以运行在非 Kubernetes 环境中，但我并不建议你花太多时间去做这个尝试。（想飞还的个好的飞机场）
