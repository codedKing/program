#  06.持久化存储-28-PV、PVC、StorageClass，这些到底在说啥？
...
> <font color="red">标注：PVC->接口 PV->具体实现。</font>
...
<font color=red>那么，这个 PV 对象，又是如何变成容器里的一个持久化存储的呢？</font>
...
- 对于“第一阶段”（Attach），Kubernetes 提供的可用参数是 nodeName，即**宿主机的名字**。
...
![img](assets/e8b2586e4e14eb54adf8ff95c5c18cd9.png)
从图中我们可以看到，在这个体系中：
