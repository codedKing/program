...
> <font color="red">标注：本章重点：Kubernetes 声明式 API 的工作原理，以及如何利用这套 API 机制，在 Kubernetes 里添加自定义的 API 对象</font>
...
![img](assets/709700eea03075bed35c25b5b6cdefda.png)
...
> <font color="red">标注：CronJob：解决了批处理任务需要定时反复执行的问题。@From《k8s权威指南第四版本》page45</font>

那么，Kubernetes 是如何对 Resource、Group 和 Version 进行解析，从而在 Kubernetes 项目里找到 CronJob 对象的定义呢？

> <font color="red">标注：这又是一个问题：Kubernetes 是如何对 Resource、Group 和 Version 进行解析，从而在 Kubernetes 项目里找到 CronJob 对象的定义呢？</font>
...
![img](assets/df6f1dda45e9a353a051d06c48f0286f.png)
