...
> <font color="red">标注：自定义控制器都干了些啥：编写main函数，编写自定义控制器，编写控制器里的业务逻辑。</font>
...
![img](assets/32e545dcd4664a3f36e95af83b571ec3.png)
图 1 自定义控制器的工作流程示意图
...
在今天这篇文章中，我为你**剖析了 Kubernetes API 编程范式的具体原理，并编写了一个自定义控制器**。
