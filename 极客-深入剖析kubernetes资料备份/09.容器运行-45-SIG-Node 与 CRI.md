...
![img](assets/914e097aed10b9ff39b509759f8b1d03-1564293926769.png)
...
不难想到，这些控制循环的责任，就是通过**控制器模式**，完成 kubelet 的某项具体职责。比如 Node Status Manager，就负责响应 Node 的状态变化，然后将 Node 的状态收集起来，并通过 Heartbeat 的方式上报给 APIServer。再比如 CPU Manager，就负责维护该 Node 的 CPU 核的信息，以便在 Pod 通过 cpuset 的方式请求 CPU 核的时候，能够正确地管理 CPU 核的使用量和可用量。
...
![img](assets/5161bd6201942f7a1ed6d70d7d55acfe-1564293927029.png)
